...
{
    /// <inheritdoc />
    public partial class rolesoم : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ContactUsModelId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_contactUsModels", x => x.ContactUsModelId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseRequrments = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherRequestss", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_TeacherRequestss_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LessonContent = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherRequestss_CategoryId",
                table: "TeacherRequestss",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherRequestss_UserId",
                table: "TeacherRequestss",
                column: "UserId");
        }
